...
@Singleton
class JellyfinDownloadScheduler
    @Inject
    constructor(
         ...
         */
        suspend fun enqueueItemIds(
            itemIds: List<String>,
            uniqueName: String = WORK_ITEMS,
        ) {
            ...
            val request =
                OneTimeWorkRequestBuilder<JellyfinDownloadWorker>()
        ...
        suspend fun enqueuePlaylistImport(
            playlistId: String,
            playlistName: String,
        ) {
            val wifiOnly = appPreferences.isWifiOnlyDownloads()
        ...
        fun observeWork(): Flow<List<WorkInfo>> = workManager.getWorkInfosByTagFlow(TAG)
